...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # mistral-small-latest, not -large: the free tier rate-limits the large
        # model with HTTP 429 after about two calls, which kills a live demo.
        DeclareLaunchArgument('model', default_value='mistral-small-latest'),
